...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='testimgs/card_detection3.jpg', help='image path')
    parser.add_argument('--onnxmodel', default='carddetection_scrfd34gkps.onnx', type=str, help='onnx model path')
